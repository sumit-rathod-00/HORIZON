...
class ScanService:
    ...
    async def _get_owned_scan(
        ...
        await self._verify_asset_owner(
            scan.asset_id,
            owner_id,
        )
    ...
    async def list_scans(
        ...
        return await self._repository.get_by_asset(
            asset_id
        )
    ...
    async def update_scan_status(
        ...
        scan = await self._get_owned_scan(
            scan_id,
            owner_id,
        )
